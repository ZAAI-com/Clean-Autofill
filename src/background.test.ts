...
function generateEmail(tabUrl: string, userDomain: string): string | null {
...
describe('generateEmail', () => {
  ...
  describe('no user domain configured', () => {
    test('returns null when userDomain is empty', () => {
...
describe('message timeout constant', () => {
  test('MESSAGE_TIMEOUT should be a reasonable value', () => {
    // The actual constant is 5000ms in background.ts
