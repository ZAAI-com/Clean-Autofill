...
Visit github.com? Get github.com@yourdomain.com.

No more typing. No more reusing the same address everywhere.
...
- Open source: https://github.com/ZAAI-com/Clean-Autofill


PERMISSIONS

- activeTab: Read the current tab's URL to extract the domain
- storage: Save your email domain setting
